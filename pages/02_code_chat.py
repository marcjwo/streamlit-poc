...
# if st.session_state.success_flag is True:
#     question_input = st.text_input("What would you like to know?")
#     if st.button("Submit question"):
#         question_result = answerQuestion(question_input, user_input)
#         st.write(question_result)


# test_bucket = "documents_qa"

# if gcs_bucket is not None:
#     createVectorStore(test_bucket)

#     chain = RetrievalQA.from_chain_type(
#         llm=VertexAI(), retriever=createVectorStore(test_bucket).as_retriever()
#     )
